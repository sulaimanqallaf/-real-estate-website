...
export const projectsData: ProjectDetail[] = [
  ...
  },
  {
    ...
    developer: { ar: "ألتيفا العقارية", en: "Altiva Properties" },
    priceFrom: { amount: 1750000, currency: "AED" },
    priceIsEstimate: false,
    deliveryDate: { ar: "يُحدد لاحقًا", en: "To be confirmed" },
    paymentPlan: [
      { ar: "30% دفعة أولى عند الحجز", en: "30% first payment on booking" },
      { ar: "20% بعد إنجاز 30% من أعمال البناء", en: "20% after 30% of construction is complete" },
      { ar: "20% أثناء مرحلة البناء", en: "20% during the construction phase" },
      { ar: "30% عند التسليم", en: "30% on handover" },
    ],
    features: [
      { ar: "فيلا مستقلة من 3 غرف نوم و3 حمامات", en: "Standalone villa with 3 bedrooms and 3 bathrooms" },
      { ar: "مسبح خاص وجلسة خارجية", en: "Private pool and outdoor seating" },
      { ar: "أرض من 800 إلى 1,200 م²، ومساحة بناء 195 م²", en: "Land from 800 to 1,200 sqm, with 195 sqm built-up area" },
      { ar: "تملك حر بملكية كاملة 100%", en: "Freehold, 100% full ownership" },
      { ar: "برنامج استثماري اختياري (المدار) بعائد سنوي مستهدف 10%", en: "Optional investment program (Al-Madar) with a 10% targeted annual return" },
      { ar: "14 ليلة إقامة سنويًا للمالك، وإدارة احترافية من ألتيفا", en: "14 nights of annual stay for the owner, with professional management by Altiva" },
    ],
    gallerySlots: 6,
    images: [
      "/projects/jais-retreats/exterior-night.jpg",
      "/projects/jais-retreats/pool-night.jpg",
      "/projects/jais-retreats/bedroom-1.jpg",
      "/projects/jais-retreats/kitchen-dining.jpg",
      "/projects/jais-retreats/bedroom-2.jpg",
      "/projects/jais-retreats/living-room.jpg",
    ],
    brochureUrl: "/brochures/jais-retreats-brochure.pdf",
    description: {
      ar: "جيس ريتريتس مجموعة فلل جبلية مستقلة من ألتيفا العقارية في مواقع مختارة بعناية برأس الخيمة، قرب جبل جيس. سعر التملك المتكامل 1,750,000 درهم يشمل الأرض والفيلا كاملة الإنشاء والتشطيبات والمسبح الخاص والأثاث والتجهيز الكامل، مع برنامج استثماري اختياري بعائد سنوي مستهدف 10%.",
      en: "Jais Retreats is a collection of standalone mountain villas by Altiva Properties on carefully selected sites in Ras Al Khaimah, near Jebel Jais. The AED 1,750,000 all-inclusive ownership price covers the land, a fully built villa with interior and exterior finishing, a private pool, and complete furnishing, with an optional investment program targeting a 10% annual return.",
    },
  },
  {
